...
public class ServicioPersistenciaMock implements IServicioPersistenciaMockRemote, IServicioPersistenciaMockLocal {
    ...
    public ServicioPersistenciaMock() {
        System.out.println("Se creó la persistencia");
        if (vendedores == null) {
            ...
            usuarios.add(new Usuario("luis", "clientclient", TipoUsuario.Cliente, "Luis Carlos Perez", 12412214l));
            usuarios.add(new Usuario("juan", "clientclient", TipoUsuario.Cliente, "Juan Fernando Castillo", 346346l));
            usuarios.add(new Usuario("carlos", "clientclient", TipoUsuario.Cliente, "Carlos Andres Ruiz", 13512512l));
            ...
            for (int e = 0; e < 8; e++) {
                ...
                venta.setComprador(usuarios.get(comprador + 2));
                comprador++;
                if (comprador == 3) {
                    comprador = 0;
                }
